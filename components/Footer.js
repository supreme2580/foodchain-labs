...
const Footer = () => {
    return(
        <div className="w-full bg-white py-3 bg-opacity-[0.38] px-16 space-y-2.5">
            <div>
                <Image src="/logo.png" width={100} height={100} />
            </div>
            <div className="flex space-x-10">
                <div className="text-lg text-black max-w-md flex-0 font-agrandir">
                ...
                <div className="flex flex-col justify-between flex-0">
                    <div>
                ...
                <div className="flex-1">
                    <div class="grid grid-rows-2 grid-flow-col gap-4 w-full font-agrandir text-black text-lg text-center">
